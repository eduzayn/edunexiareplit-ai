          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div>
                  <FormLabel htmlFor="item-description">Descrição*</FormLabel>
                  <div className="mt-1">
                    <Textarea
                      id="item-description"
                ...
                <div>
                  <FormLabel htmlFor="product-select">Produto</FormLabel>
                ...
                <div>
                  <FormLabel htmlFor="item-quantity">Quantidade*</FormLabel>
                  <Input
                    id="item-quantity"
                    type="number"
                    min="1"
                ...
                <div>
                  <FormLabel htmlFor="item-price">Preço Unitário*</FormLabel>
                  <Input
                    id="item-price"
                    type="number"
                    min="0"
                ...
                <div>
                  <FormLabel htmlFor="item-discount">Desconto</FormLabel>
                  <Input
                    id="item-discount"
                    type="number"
                    min="0"
                ...
                <div>
                  <FormLabel htmlFor="item-tax">Imposto (%)</FormLabel>
                  <Input
                    id="item-tax"
                    type="number"
                    min="0"
                ...
                <div className="md:col-span-3 flex justify-end mt-2">
                  <Button type="button" onClick={addItemToCharge}>
                  ...
                  <TableBody>
                    {items.length === 0 ? (
                      ...
                      items.map((item) => {
                        ...
                        const taxAmount = (item.tax / 100) * subtotal;
                        ...
                        return (
                          <TableRow key={item.id}>
                            ...
                            <TableCell className="text-right">
                              {item.discount > 0 ? (
                                new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(item.discount)
                              ) : '-'}
                            </TableCell>
                            <TableCell className="text-right">
                              {item.tax > 0 ? `${item.tax}%` : '-'}
                  ...
                  <div className="w-full md:w-1/3 space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold">
                        {new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(calculateChargeTotal())}
                      </span>
                    </div>
                  </div>
                </div>
